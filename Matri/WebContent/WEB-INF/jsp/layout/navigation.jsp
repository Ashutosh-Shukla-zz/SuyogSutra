                    ...
                    <div class="c-navbar-wrapper clearfix">
                        ...
                        <nav class="c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-theme c-fonts-uppercase c-fonts-bold">
                            <ul class="nav navbar-nav c-theme-nav">
                                ...
                                <li>
                                    <a href="javascript:;" class="c-link dropdown-toggle">Login
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                    
                                </li>
                                 <li>
                                    <a href="<c:url value="adminDetails"/>" class="c-link dropdown-toggle">Admin
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
        ...
        <div class="modal fade c-content-login-form" id="login-form" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content c-square">
                    ...
                    <div class="modal-body">
                        <h3 class="c-font-24 c-font-sbold">Hey There</h3>
                        <p>Let's make today a great day!</p>
                        <form action="${pageContext.request.contextPath}/login" method="post">
                            <div class="form-group">
                                <label for="login-email" class="hide">Email</label>
                                <input type="email" required="required" class="form-control input-lg c-square" id="login-email" name="login-email" placeholder="Email"> </div>
                            <div class="form-group">
                                <label for="login-password" class="hide">Password</label>
                                <input type="password" required="required" class="form-control input-lg c-square" id="login-password" name="login-password" placeholder="Password"> </div>
